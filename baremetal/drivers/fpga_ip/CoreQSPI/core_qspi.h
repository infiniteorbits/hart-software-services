...
/*******************************************************************************
  ...
  @endcode
 */
    static inline void QSPI_disable(qspi_instance_t * this_qspi) {
        HAL_set_32bit_reg(this_qspi->base_address, CONTROL,
                          ((uint32_t)
                           (HAL_get_32bit_reg(this_qspi->base_address, CONTROL))
...
/*******************************************************************************
  ...
  @endcode
 */ void QSPI_configure
     (qspi_instance_t * this_qspi, const qspi_config_t * config);
 ...
 */
    static inline void QSPI_write_direct_access_reg
        (qspi_instance_t * this_qspi, uint32_t value) {
 ...
 */
    static inline uint32_t QSPI_read_status(qspi_instance_t * this_qspi) {
