...
#define MMC_CMD_40_GO_IRQ_STATE 40u /** R5  Rsp    */
    ...
    typedef enum R1_CARD_STATUS_RESPONSE_ {
        ADDRESS_OUT_OF_RANGE = 0x00000080u,
                                          /**< RR1 */
        ...
        WP_ERASE_SKIP = 0x00800000u,
                                   /**< RR3 */
        RESERVED_14 = 0x00400000u,
        ERASE_RESET = 0x00200000u,
        CURRENT_STATE12_9_MASK = ((0x0Fu << 1) << 16),
        CURRENT_STATE_RCV = ((0x06u << 1) << 16),
                                /**< in this state when rx data from eMMC */
        CURRENT_STATE_DATA = ((0x05u << 1) << 16),
                                /**< in this state when sending data to eMMC */
        CURRENT_STATE_TRAN = ((0x04u << 1) << 16),
                                                 /**< ready to send/receive */
        READY_FOR_DATA = 0x00010000u,

        SWITCH_ERROR = 0x80000000u,
                                  /**< RR4 */
