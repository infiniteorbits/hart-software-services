...
/**
 * coremmc_cif_send_cmd()
 * See ".h" for details of how to use this function.
 */
cif_response_t coremmc_cif_send_cmd(addr_t addr, uint32_t cmd_arg, uint8_t cmd_type)
{
    ...
    coremmc_send_mmc_cmd(addr, cmd_arg, cmd_type, CHECK_IF_CMD_SENT_POLL);
