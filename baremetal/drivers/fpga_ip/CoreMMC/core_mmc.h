 ...
 */
    ...
    typedef struct mmc_instance {
        ...
        uint8_t hw_ext_csd_rev;
                          /**< This contains the extended CSD rev read during
                    eMMC initialisation*/
        uint8_t hw_card_type;
                        /**< This contains the cared type read from the extended
                  CSD register*/
        uint16_t sector_size;
        uint8_t access_mode;
        uint8_t hw_fifo_depth;
        uint8_t hw_maj_revision;
                           /**< This is the major version of CoreMMC. Only
                    present in Cores >= 3.00*/
        uint8_t hw_min_revision;
                           /**< This is the minor version of CoreMMC. Only
 ...
 */
    ...
    mmc_transfer_status_t MMC_init(mmc_instance_t * this_mmc,
                                   addr_t base_address,
 ...
 */
    ...
    mmc_transfer_status_t MMC_single_block_write(const mmc_instance_t *
                                                 this_mmc,
