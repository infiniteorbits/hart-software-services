...
*/
#define LIBERO_SETTING_IOMUX0_CR    0x000031C0UL
    ...
    /* MDIO0_FABRIC                      [12:1]  RW value= 0x1 */
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_IOMUX4_CR    0xBB664444UL
    ...
    /* PAD28                             [24:4]  RW value= 0xB */
    /* PAD29                             [28:4]  RW value= 0xB */
#endif
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_IOMUX5_CR    0xFF77F77BUL
    /* PAD30                             [0:4]   RW value= 0xB */
...
/*IO electrical configuration for MSSIO pad */
#define LIBERO_SETTING_MSSIO_BANK2_IO_CFG_14_15_CR    0x00290029UL
    /* IO_CFG_14                         [0:16]  RW value= 0x0029 */
    /* IO_CFG_15                         [16:16] RW value= 0x0029 */
#endif
