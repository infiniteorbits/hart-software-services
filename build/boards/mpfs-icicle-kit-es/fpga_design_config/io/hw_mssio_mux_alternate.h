...
*/
#define LIBERO_SETTING_ALT_IOMUX0_CR    0x00000180UL
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_ALT_IOMUX2_CR    0x00FFFFF0UL
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_ALT_IOMUX4_CR    0x7766FFFFUL
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_ALT_IOMUX5_CR    0xFFFFF77FUL
