...
*/
#define LIBERO_SETTING_IOMUX0_CR    0x00000180UL
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_IOMUX4_CR    0x7766FFFFUL
    ...
    /* PAD28                             [24:4]  RW value= 0x7 */
    /* PAD29                             [28:4]  RW value= 0x7 */
#endif
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_IOMUX5_CR    0xFFFFF77FUL
    /* PAD30                             [0:4]   RW value= 0xF */
    /* PAD31                             [4:4]   RW value= 0x7 */
    /* PAD32                             [8:4]   RW value= 0x7 */
...
/*IO electrical configuration for MSSIO pad */
#define LIBERO_SETTING_MSSIO_BANK2_IO_CFG_0_1_CR    0x08290861UL
    /* IO_CFG_0                          [0:16]  RW value= 0x0861 */
...
/*IO electrical configuration for MSSIO pad */
#define LIBERO_SETTING_MSSIO_BANK2_IO_CFG_16_17_CR    0x08290861UL
    /* IO_CFG_16                         [0:16]  RW value= 0x0861 */
