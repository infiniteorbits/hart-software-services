...
/*IP Blk = ADDR_MAP Access=RW */
#define LIBERO_SETTING_CFG_CHIPADDR_MAP    0x0000001CUL
    /* CFG_CHIPADDR_MAP                  [0:32]  RW value= 0x00001C */
#endif
...
/*IP Blk = ADDR_MAP Access=RW */
#define LIBERO_SETTING_CFG_ROWADDR_MAP_2    0x01B69961UL
    /* CFG_ROWADDR_MAP_2                 [0:32]  RW value= 0x01B69961 */
#endif
...
#define LIBERO_SETTING_CFG_SR_ABORT    0x00000000UL
    /* CFG_SR_ABORT                      [0:32]  RW value= 0x00000000 */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RAS    0x0000000EUL
    /* CFG_RAS                           [0:32]  RW value= 0xE */
#endif
#if !defined (LIBERO_SETTING_CFG_RCD)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RCD    0x00000006UL
    /* CFG_RCD                           [0:32]  RW value= 0x6 */
#endif
#if !defined (LIBERO_SETTING_CFG_RRD)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RRD    0x00000004UL
    /* CFG_RRD                           [0:32]  RW value= 0x4 */
#endif
#if !defined (LIBERO_SETTING_CFG_RP)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RP    0x00000006UL
    /* CFG_RP                            [0:32]  RW value= 0x6 */
#endif
#if !defined (LIBERO_SETTING_CFG_RC)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RC    0x00000014UL
    /* CFG_RC                            [0:32]  RW value= 0x14 */
#endif
#if !defined (LIBERO_SETTING_CFG_FAW)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_FAW    0x0000000EUL
    /* CFG_FAW                           [0:32]  RW value= 0xE */
#endif
#if !defined (LIBERO_SETTING_CFG_RFC)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RFC    0x00000068UL
    /* CFG_RFC                           [0:32]  RW value= 0x68 */
#endif
#if !defined (LIBERO_SETTING_CFG_RTP)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RTP    0x00000004UL
    /* CFG_RTP                           [0:32]  RW value= 0x4 */
#endif
#if !defined (LIBERO_SETTING_CFG_WR)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_WR    0x00000006UL
    /* CFG_WR                            [0:32]  RW value= 0x6 */
#endif
#if !defined (LIBERO_SETTING_CFG_WTR)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_WTR    0x00000004UL
    /* CFG_WTR                           [0:32]  RW value= 0x4 */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_STARTUP_DELAY    0x00013880UL
    /* CFG_STARTUP_DELAY                 [0:32]  RW value= 0x13880 */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_XS    0x0000006CUL
    /* CFG_XS                            [0:32]  RW value= 0x6C */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_XPR    0x0000006CUL
    /* CFG_XPR                           [0:32]  RW value= 0x6C */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_ZQ_CAL_PER    0x00013880UL
    /* CFG_ZQ_CAL_PER                    [0:32]  RW value= 0x13880 */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_MEMORY_TYPE    0x00000008UL
    /* CFG_MEMORY_TYPE                   [0:32]  RW value= 0x8 */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_ZQINIT_CAL_DURATION    0x00000200UL
    /* CFG_ZQINIT_CAL_DURATION           [0:32]  RW value= 0x200 */
#endif
#if !defined (LIBERO_SETTING_CFG_ZQ_CAL_L_DURATION)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_ZQ_CAL_L_DURATION    0x00000100UL
    /* CFG_ZQ_CAL_L_DURATION             [0:32]  RW value= 0x100 */
#endif
#if !defined (LIBERO_SETTING_CFG_ZQ_CAL_S_DURATION)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_ZQ_CAL_S_DURATION    0x00000040UL
    /* CFG_ZQ_CAL_S_DURATION             [0:32]  RW value= 0x40 */
#endif
